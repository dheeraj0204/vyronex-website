    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Build smarter.</span>
        ...
        <p
          className={`max-w-xl text-lg lg:text-xl text-white/70 leading-relaxed mb-10 transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
          VYRONEX builds custom AI agents, AI-powered applications, automation
          systems and high-performance digital experiences that help businesses
          and individuals work smarter.
        </p>
        ...
        >
          <a
            href="#contact"
            className="inline-flex items-center justify-center rounded-full bg-white text-black px-8 h-14 text-base font-medium hover:bg-white/90 transition-colors"
          >
            Automate Your Work
          </a>
          <a
            href="#features"
            className="inline-flex items-center justify-center rounded-full border border-white/30 text-white px-8 h-14 text-base font-medium hover:bg-white/10 transition-colors"
          >
            Build With AI
          </a>
        </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "AI Agents", label: "Custom intelligent agents built for real-world tasks." },
            { value: "Automation", label: "Automate repetitive workflows across your existing tools." },
            { value: "Custom AI", label: "LLMs, chatbots, voice agents and AI apps built for you." },
          ].map((stat) => (
            <div key={stat.value} className="flex flex-col gap-2 max-w-[180px] lg:max-w-[240px]">
