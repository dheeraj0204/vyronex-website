...
const steps = [
  {
    ...
    description: "We understand your workflow, business requirements and repetitive tasks to identify where AI and automation can create the most value.",
  },
  {
    number: "02",
    title: "Build",
    subtitle: "the solution",
    description: "We design and develop custom AI agents, applications, websites, automations and digital systems around your requirements.",
  },
  {
    number: "03",
    title: "Automate",
    subtitle: "& improve",
    description: "We connect your tools, automate workflows and continuously improve the system as your needs evolve.",
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-5xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-16 opacity-0"
            }`}>
              <span className="block">Understand.</span>
              <span className="block text-white/30">Build.</span>
              <span className="block text-white/10">Automate.</span>
            </h2>
          </div>
