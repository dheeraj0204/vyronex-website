...
const regions = [
  { name: "Custom AI Agents", detail: "Reasoning & task execution", tag: "AI" },
  { name: "Business Automation", detail: "Workflows across your tools", tag: "AUTO" },
  { name: "Websites & Apps", detail: "Dynamic & 3D experiences", tag: "WEB" },
  { name: "Software & IT", detail: "Systems, cloud & data", tag: "TECH" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              <h2 className={`text-5xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
                ...
                AI that works
                <br />
                <span className="text-muted-foreground">across your stack.</span>
              </h2>

              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                isVisible ? "opacity-100" : "opacity-0"
              }`}>
                Connect your AI systems, websites, workflows and business tools
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground max-w-md">
                Custom AI solutions built around your workflow — agents, applications and intelligent platforms connected to the tools you already use.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-4xl lg:text-5xl font-display">Automation</span>
              <span className="block text-sm text-muted-foreground mt-2">Connect repetitive tasks across the tools you already use</span>
            </div>
            
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-4xl lg:text-5xl font-display">Digital</span>
              <span className="block text-sm text-muted-foreground mt-2">Websites, applications and intelligent platforms built to scale</span>
            </div>
          </div>
        </div>
