...
const logos: Record<string, React.ReactNode> = {
  ...
  Webhooks: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
      <path d="M10 4.5a4 4 0 1 0-2 3.5" />
      <path d="M6 19a4 4 0 1 0 4-4h-3" />
      <path d="M18 15a4 4 0 1 0-3-6.7L13.5 11" />
    </svg>
  ),
  "Custom AI": (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
...
const integrations = [
  ...
  { name: "Custom AI", category: "AI" },
  { name: "Automation", category: "Auto" },
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-5xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Connect your work.
          <br />
          <span className="text-muted-foreground">Automate the rest.</span>
        </h2>

        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          Bring AI into the tools you already use. VYRONEX connects AI agents and automation workflows across your business, productivity and communication stack.
        </p>
      </div>
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`flex flex-wrap items-center justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 pb-32 lg:pb-40 ${
          ...
          <div className="flex flex-wrap gap-12">
            {[
              { value: "AI + Automation", label: "Connect intelligent systems to your workflow" },
              { value: "APIs", label: "Build custom connections between your tools" },
              { value: "Webhooks", label: "Trigger real-time automated workflows" },
            ].map((stat) => (
