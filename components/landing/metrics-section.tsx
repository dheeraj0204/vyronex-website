...
const metrics = [
  { 
    ...
    suffix: "/7", 
    prefix: "",
    label: "Automation that runs",
    sublabel: "around the clock",
  },
  { 
    value: 10, 
    suffix: "+", 
    ...
    sublabel: "we connect and integrate",
  },
  { 
    value: 3, 
    suffix: "+", 
    ...
    sublabel: "OpenAI, Gemini, Anthropic",
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            ...
            <h2 className={`text-5xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              Built to automate
              <br />
              <span className="text-muted-foreground">real work.</span>
            </h2>
          </div>
        </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span className="text-foreground">+ custom APIs</span>
        </div>
      </div>
    </section>
  );
