...
const plans = [
  {
    ...
    tagline: "Share your idea",
    features: [
      "A repetitive task or workflow",
      "A business problem or AI idea",
      "A website or app requirement",
  ...
  {
    name: "Development",
    description: "We'll design the right solution.",
    tagline: "We build it",
    features: [
      "Custom AI agents & chatbots",
      "Automation across your tools",
      "Websites, 3D & applications",
  ...
  {
    name: "Operations",
    description: "Put your work on autopilot.",
    tagline: "Go live",
    features: [
      "Deploy & connect your tools",
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-5xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Have a task?
              <br />
              <span className="text-stroke">Automate it.</span>
            </h2>
          </div>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="p-8 lg:p-10">
                  ...
                  {/* Step tagline */}
                  <div className="mb-8">
                    <span className="text-4xl lg:text-5xl font-display">{plan.tagline}</span>
                  </div>
