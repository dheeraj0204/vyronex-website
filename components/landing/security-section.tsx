...
const securityFeatures = [
  {
    ...
    description: "Agents act only within defined goals and scopes.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Defined permissions",
    description: "Access is scoped to exactly what a task needs.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full transparency",
    description: "Every action is logged and inspectable.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Human oversight",
    description: "You stay in control of every workflow.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Goal-driven", "Scoped access", "Human-in-the-loop", "Auditable"];
    ...
    <section id="security" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          {/* Title — full width */}
          <h2 className={`text-5xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              We design AI agents and automation systems around clear goals, defined workflows and controlled access — so automation works for you, not against you.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Responsible AI</span>
              <div className="mt-8">
                <span className="text-6xl lg:text-7xl font-display">In control</span>
                <span className="block text-muted-foreground mt-2">AI that acts within the limits you set</span>
              </div>
            </div>
