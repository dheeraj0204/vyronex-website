...
const testimonials = [
  {
    quote: "We build custom AI agents that reason, communicate and execute real tasks across your business tools.",
    author: "AI Agents",
    role: "Autonomous systems",
    company: "AI Agents",
    metric: { value: "Custom", label: "Built around your workflow" },
  },
  {
    quote: "Repetitive workflows, reporting and communication get automated so your team can focus on real work.",
    author: "Business Automation",
    role: "Workflow automation",
    company: "Automation",
    metric: { value: "24/7", label: "Automated operations" },
  },
  {
    quote: "AI voice agents and custom chatbots handle support, lead qualification and communication end to end.",
    author: "Voice & Chatbots",
    role: "Conversational AI",
    company: "Voice AI",
    metric: { value: "Multi", label: "Channels supported" },
  },
  {
    quote: "AI automation runs inside clear boundaries, defined permissions and human oversight — always controlled.",
    author: "Responsible AI",
    role: "Governed automation",
    company: "Security",
    metric: { value: "Secure", label: "Controlled by design" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Built around
              <span className="text-background/40"> your goals.</span>
            </h2>
          </div>
